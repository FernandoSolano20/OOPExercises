...
import com.tupuntodeventa.bl.Orden.Type.ClientOrden;
...
public class Controller {
    ...
    public String registerOrden(String type, ArrayList<Integer> codes) throws Exception {
        Orden orden = new ClientOrden(actualUser,type);
        Coupon coupon = couponDao.getCouponAvailable();
        if(coupon != null){
